                                ...
                                letterData.map((item, index) => {
                                    ...
                                    return (
                                        <TouchableWithoutFeedback key={'letter_' + index} onPress={() => {
                                            this.setState({ selectedPos: index })
                                            ...
                                            <View style={[styles.letterItemView, otherStyle, this.state.selectedPos === index ? {
                                                padding: 5,
                                                ...
                                                <Text numberOfLines={0} style={[{
                                                    fontSize: 15,
                                                    color: this.state.selectedPos === index ? '#fff' : '#333333'
                                                }, this.props.letterTextStyle]}>{item}</Text>
                                            </View>
                                        </TouchableWithoutFeedback>
                                    )
                                })
